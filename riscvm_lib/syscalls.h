...
static inline int32_t win_syscall5(int32_t id, uint64_t a0, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
    ...
    asm volatile("scall"
                 : "+r"(_a0)
                 : "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4), "r"(windows_id), "r"(syscall_id));
    return _a0;
}

static inline int32_t
win_syscall6(int32_t id, uint64_t a0, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
    ...
    asm volatile("scall"
                 : "+r"(_a0)
                 : "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4), "r"(_a5), "r"(windows_id), "r"(syscall_id));
    return _a0;
}

static inline int32_t
win_syscall7(int32_t id, uint64_t a0, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
    ...
    asm volatile("scall"
                 : "+r"(_a0)
                 : "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4), "r"(_a5), "r"(_a6), "r"(windows_id), "r"(syscall_id));
    return _a0;
}

static inline int32_t win_syscall8(
    int32_t id, uint64_t a0, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7
)
{
    ...
    asm volatile(
        "scall"
        : "+r"(_a0)
        : "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4), "r"(_a5), "r"(_a6), "r"(_a7), "r"(windows_id), "r"(syscall_id)
    );
    return _a0;
}

static inline int32_t win_syscall9(
    int32_t id, uint64_t a0, uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8
)
{
    ...
    asm volatile(
        "scall"
        : "+r"(_a0)
        : "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4), "r"(_a5), "r"(_a6), "r"(_a7), "r"(_a8), "r"(windows_id), "r"(syscall_id)
    );
    return _a0;
}

static inline int32_t win_syscall10(
    int32_t  id,
    uint64_t a0,
    uint64_t a1,
    uint64_t a2,
...
static inline int32_t win_syscall11(
    int32_t  id,
    uint64_t a0,
    uint64_t a1,
    uint64_t a2,
...
static inline int32_t win_syscall12(
    int32_t  id,
    uint64_t a0,
    uint64_t a1,
    uint64_t a2,
...
static inline int32_t win_syscall13(
    int32_t  id,
    uint64_t a0,
    uint64_t a1,
    uint64_t a2,
...
static inline void sys_abort()
{
    syscall0(SYSCALL_ABORT);
}

static inline void sys_prints(const char* s)
{
    syscall1(SYSCALL_PRINTS, (long)(s));
}
static inline void sys_printi(long i)
{
    syscall1(SYSCALL_PRINTI, i);
}

static inline void* sys_memset(void* vdest, int ch, size_t size)
{
    return (void*)(uintptr_t)syscall3(SYSCALL_MEMSET, (long)vdest, ch, (long)size);
}
static inline void* sys_memcpy(void* vdest, const void* vsrc, size_t size)
{
    return (void*)(uintptr_t)syscall3(SYSCALL_MEMCPY, (long)vdest, (long)vsrc, (long)size);
}
static inline void* sys_memmove(void* vdest, const void* vsrc, size_t size)
{
    return (void*)(uintptr_t)syscall3(SYSCALL_MEMMOVE, (long)vdest, (long)vsrc, (long)size);
}
static inline int sys_memcmp(const void* vdest, const void* vsrc, size_t size)
{
    return syscall3(SYSCALL_MEMCMP, (long)vdest, (long)vsrc, (long)size);
}
