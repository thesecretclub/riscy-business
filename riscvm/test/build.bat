@echo off
set FLAGS=-target riscv64 -march=rv64g -mcmodel=medany -fno-exceptions -fshort-wchar -Os
...
if not %ERRORLEVEL%==0 exit /b
ld.lld.exe -o main.elf --oformat=elf -emit-relocs -T ..\lib\linker.ld --Map=main.map crt0.o main.o test.o test2.o
if not %ERRORLEVEL%==0 exit /b
