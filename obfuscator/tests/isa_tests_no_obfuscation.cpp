...
class NoObfuscation : public ::testing::TestWithParam<Test>
{
  protected:
...
ObfuscatorLib::Obfuscator NoObfuscation::obfuscator;
std::string               NoObfuscation::functionName;
std::vector<uint8_t>      NoObfuscation::code;
void*                     NoObfuscation::execMemory = nullptr;
riscvm_run_t              NoObfuscation::riscvmRun  = nullptr;

TEST_P(NoObfuscation, RunIsaTestCase)
{
    using namespace vm;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    [](const ::testing::TestParamInfo<NoObfuscation::ParamType>& info)
    {
